...
public class NumberService {
    ...
    static Number parseAndValidate(String symbol) throws Exception {
        ...
        if (value < 1 || value > 10) {
            throw new Exception("Туура эмес сан колдондунуз, 1ден 10го чейинки сандарды колдонунуз.");
        }
    ...
    static Number parseAndValidate(String symbol, NumberType type) throws Exception {
        ...
        if (number.getType() != type) {
            throw new RuntimeException("Типтери ар кандай сандарды кoлдондунуз, бир типтеги сандарды колдонунуз.");
        }
    ...
    static int toArabicNumber(String roman) throws Exception {
        ...
        while (i < roman.length()) {
            ...
            if (num < 0) throw new Exception("Туура эмес рим саны.");
            i++;
            if (i == roman.length()) {
                result += num;
            } else {
